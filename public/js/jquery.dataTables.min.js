...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Début",sLast:"Fin",sNext:" Suivant",sPrevious:"Précédent "},sEmptyTable:"No data available in table",sInfo:"Affichage _START_ sur _END_ pour _TOTAL_ entrées",sInfoEmpty:"Affichage 0 sur 0 pour 0 entrées",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Afficher _MENU_ enregistrements",sLoadingRecords:"Chargement...",sProcessing:"En cours...",sSearch:"Rechercher :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrement trouvé"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
