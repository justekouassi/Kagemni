                        ...
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                ...
                                <a class="ml-auto btn btn-primary"
                                    href="/etudiants.create">Ajouter</a>
                            </div>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="http://inphb-mat-info.herokuapp.com/etudiants/2"
                                                    method="POST">
                                                    <a href="http://inphb-mat-info.herokuapp.com/etudiants/2/edit"
                                                    ...
                                                    <input type="hidden" name="_token"
                                                        value="J3eKXKzbV4U3TC6QXwDIywR2BQcW0ufo4cUalrkc"> <input
                                        ...
                                        <tr>
                                            ...
                                            <td>Conception et realisation d&#039;un capteur de présence</td>
                                            <td>
                                                <form action="http://inphb-mat-info.herokuapp.com/etudiants/3"
                                                    method="POST">
                                                    <a href="http://inphb-mat-info.herokuapp.com/etudiants/3/edit"
                                                        class="btn btn-primary btn-sm">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="14"
                                                            height="14" viewBox="0 0 24 24" fill="none"
                                                            stroke="currentColor" stroke-width="2"
